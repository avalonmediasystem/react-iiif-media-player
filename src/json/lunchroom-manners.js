...
export default {
  ...
  type: 'Manifest',
  id:
    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest',
  ...
  metadata: [
    ...
    },
    {
      ...
      value: {
        '@none': ['http://rightsstatements.org/vocab/UND.0/']
      }
    }
  ],
  items: [
    {
      type: 'Canvas',
      id:
        'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b',
      label: 'lunchroom_manners_1024kb.mp4',
      thumbnail: [
        {
          id:
            'http://fluorine.dlib.indiana.edu/downloads/08612n52b?file=thumbnail',
          type: 'Image'
        }
      ],
      items: [
        {
          type: 'AnnotationPage',
          id:
            'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b/annotation_pagef783478-ae11-473f-9eaa-1f717a18756c',
          items: [
            {
              type: 'Annotation',
              motivation: 'painting',
              ...
              body: {
                ...
                items: [
                  {
                    id:
                      'http://fluorine.dlib.indiana.edu/downloads/08612n52b?file=mp4',
                    type: 'Video',
                    format: 'video/mp4',
                    height: 360,
                    width: 480,
                  ...
                  {
                    id:
                      'http://fluorine.dlib.indiana.edu/downloads/08612n52b?file=webm',
                    type: 'Video',
                    format: 'video/mp4',
                    height: 360,
                    width: 480,
          ...
          items: [
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=157,160',
                  type: 'Canvas'
                }
              ]
            },
            ...
            },
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=165,178',
                  type: 'Canvas'
                }
              ]
            }
          ...
          items: [
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=227,245',
                  type: 'Canvas'
                }
              ]
            },
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=258,288',
                  type: 'Canvas'
                }
              ]
            },
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=301,308',
                  type: 'Canvas'
                }
              ]
            }
          ...
          items: [
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=323,333',
                  type: 'Canvas'
                }
              ]
            },
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=362,378',
                  type: 'Canvas'
                }
              ]
            }
          ...
          items: [
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=448,492',
                  type: 'Canvas'
                }
              ]
            },
            {
              ...
              items: [
                {
                  id:
                    'http://fluorine.dlib.indiana.edu/concern/generic_works/2n49t1699/manifest/canvas/08612n52b#t=511,527',
                  type: 'Canvas'
                }
              ]
            }
